...
const AllCourses = () => {
    ...
    const { data: courses = [], isLoading } = useQuery({
        ...
        queryFn: async () => {
            ...
            // Ensure we only show approved courses
    ...
    return (
        <section className=" mt-25 bg-slate-50 min-h-screen">
                        ...
                        <div key={course._id} className="bg-white rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all group flex flex-col">
                            ...
                            <div className="p-5 flex flex-col flex-grow">
                                ...
                                <div className="mt-auto flex items-center justify-between pt-4 border-t border-slate-50">
                                    ...
                                    <button className="text-cyan-500 font-bold text-xs flex items-center gap-1 hover:gap-2 transition-all">
                ...
                {totalPages > 1 && (
                    <div className="flex justify-center items-center mt-16 gap-2">
                        <button 
                            ...
                            className="p-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 disabled:opacity-50 transition-all"
                        >
