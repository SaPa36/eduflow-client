...
import { FaGoogle, FaGithub, FaRocket, FaShieldAlt, FaGlobe } from 'react-icons/fa';
            ...
            <div className="max-w-5xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row-reverse h-auto md:h-[600px]">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex items-center gap-3 text-sm">
                                <div className="p-2 bg-white/10 rounded-lg"><FaRocket className="text-cyan-300" /></div>
                                <span>Fast-track your career growth</span>
                            </div>
                            <div className="flex items-center gap-3 text-sm">
                                <div className="p-2 bg-white/10 rounded-lg"><FaShieldAlt className="text-cyan-300" /></div>
                                <span>Verified industry certifications</span>
                            </div>
                            <div className="flex items-center gap-3 text-sm">
                                <div className="p-2 bg-white/10 rounded-lg"><FaGlobe className="text-cyan-300" /></div>
                                <span>Join a global student community</span>
                            </div>
                        </div>

                        <div className="border-t border-white/20 pt-6">
                            <p className="text-xs opacity-80">Already part of the family? Log in to continue your progress.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full md:w-[55%] p-8 md:p-12 bg-white flex flex-col justify-center">
                    <div className="max-w-sm mx-auto w-full">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900 text-center">Create Account</h3>
                        ...
                        <form className="space-y-4">
                            ...
                            <div className="flex items-center gap-2 py-1">
                                <input type="checkbox" className="checkbox checkbox-xs checkbox-cyan" required />
